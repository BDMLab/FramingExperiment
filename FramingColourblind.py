...
expName = 'FramingColourblind'  # from the Builder filename that created this script
...
ProbabilityLeft = visual.ImageStim(win=win, name='ProbabilityLeft',
    image=u'Stimuli/Colourblind/Keep80.jpg', mask=None, units='cm',
...
RestText = visual.TextStim(win=win, ori=0, name='RestText', text=u'Great! Now have a rest and press space when you are ready to begin the next block.', font=u'Arial', pos=[0, 0], height=2, units='cm', wrapWidth=30, color=u'white', colorSpace=u'rgb', opacity=1, depth=0.0)

# Instalize components for "Thank You"
ThankYouClock = core.Clock()
ThankYouText = visual.TextStim(win=win, ori=0, name='ThankYouText', text=u'You have now completed this experiment. Thank you for your participation. Please inform the experimenter that you have finished.', font=u'Arial', height=2, units='cm', pos=[0, 0], wrapWidth=30, color=u'white', colorSpace=u'rgb', opacity=1, depth=0.0)
